...
typedef enum
{
    ...
    at86rf215_radio_agc_relative_atten_42_db = 7,
} at86rf215_radio_agc_relative_atten_en;

// Structure for register RFn_AGCC
typedef struct
{
    // commands
...
// Structure for register RFn_AUXS && RFn_PADFE
typedef struct
{
...
// Structure for register RFn_RXBWC && RFn_RXDFE
typedef struct
{
...
// Structure for register RFn_EDC, RFn_EDD, RFn_EDV
typedef struct
{
    // cmd
...
// Structure for register RFn_TXCUTC, RFn_PAC, RFn_TXDFE
typedef struct
{
...
// Struture for register RFn_PLL and RFn_PLLCF
typedef struct
{
